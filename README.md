...
Latest release
--------------
The latest stable release of the 3D City Database WFS interface is 5.0.0.

Download a ZIP file of the WFS [here](https://github.com/3dcitydb/web-feature-service/releases/download/v5.0.0/3DCityDB-Web-Feature-Service-5.0.0.zip).
...
[online](https://3dcitydb-docs.readthedocs.io/en/version-2021.1/wfs/).
...
[online documentation](https://3dcitydb-docs.readthedocs.io/en/version-2021.1/wfs/).
